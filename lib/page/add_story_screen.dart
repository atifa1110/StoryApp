                      ...
                      return Column(
                        children: [
                          ...
                          OutlinedButton(
                            ...
                            onPressed: () async {
                              final result = await context.pushNamed<LatLng>(Routes.addLocation.name);
                              provider.updateSelectedLocation(result);
                            },
                          ),
                          const SizedBox(height: 8),
                          Text(
                            provider.selectedLocation != null
                                ? 'Selected Location: ${provider.selectedLocation?.latitude}, ${provider.selectedLocation?.longitude}'
                          ...
                          ElevatedButton(
                            ...
                            onPressed: () {
                              if (_formKey.currentState?.validate() == true &&
                                  provider.selectedImage != null && provider.selectedLocation !=null) {
                                ...
                                showToast("Please select location before uploading.");
                              }
                            },
                            child: const Row(
                              mainAxisAlignment: MainAxisAlignment.center,
